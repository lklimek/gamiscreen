# Copilot Instructions for Gamiscreen
...
1. Before writing any code:
   ...
   5. Identify tasks to execute and write them down in docs/todos/ (markdown formatted TODO list with checkboxes)
...
- gamiscreen-server/ - Rust server exposing REST API and serving the web UI
- gamiscreen-client/ - Linux agent and CLI (Timekpr‑Next integration)
- gamiscreen-web/ - React + TypeScript SPA (management interface; embedded into android app)
...
## Technology Stack
- Backend: Rust (workspace with gamiscreen-server, gamiscreen-client, gamiscreen-shared)
- Frontend: React + TypeScript (gamiscreen-web)
- Mobile: Android (embedding gamiscreen-web)
